...
const JobseekerLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('🔍 Login attempt - Email:', email, 'Expected UserType: jobseeker');
      ...
      <div className="login-container">
        <div className="login-card">
          <div className="login-header">
            ...
            <p>Access your jobseeker dashboard</p>
            <div className="login-type-badge jobseeker">
              <span className="badge-icon">👤</span>
              <span className="badge-text">Jobseeker Portal</span>
            </div>
          </div>
        ...
        <div className="login-footer">
          <p>
            Don't have a jobseeker account?{' '}
          ...
          <p>
            ...
            <Link to="/login/employer" className="switch-login-link">
              Click here
            </Link>
          </p>
          </div>
